...
convertidos_enteros = int(numero_binario, 2) * int(numero_octal, 8) * int(numero_hexadecimal, 16)

multiplicacion_de_numeros = convertidos_enteros
...
convertidos_enteros = int(numero_01) - int(numero_02, 16) -int(numero_03, 8) - (numero_04)
resultado_resta = convertidos_enteros
